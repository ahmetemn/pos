        ...
        <>
            ...
            <div className="border-b mb-6">
                <header className="header py-5 px-6 flex justify-between  items-center gap-10">
                    ...
                    <div className="menu-links  flex items-center gap-8  md:static fixed bottom-0 md:w-auto w-screen md:bg-transparent bg-white left-0 md:border-t-0 border-t md:px-0 px-4">
